...
TOPDIR = r'c:\Shares\vrty\vrty3\python\DATA'    #skúsiť r'./Data', teda TOPDIR by bola curdir/Data
EXPVRTLOZ = r'c:\Shares\vrty\vrty3\python\ExpVrtLozOld.exe' 
EXPVRT =  r'c:\Shares\vrty\vrty3\python\ExpVrt2025.exe'


# TOPDIR = r'f:\aaa\PROGRAM\python\vrty2\Data'    #skúsiť r'./Data', teda TOPDIR by bola curdir/Data
